...
import numpy as np
from agent.TD3.TD3 import TD3Agent, train_TD3
...
env = Env(batch_size=64, render_needed=False)
logger.info("Environment initialized")

ddpgAgent = TD3Agent(env.state_dim,env.action_dim)
logger.info("DDPG agent initialized")

# # Train the DQN agent
logger.info("Training DDPG agent")
TRAINING_START = time.time()
train_TD3(ddpgAgent, env)
